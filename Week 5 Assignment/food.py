class DeliveryPartner:
    ...
    def display(self):
        ...
        print(f"{self.name} ({self.partner_id}): {self.deliveries} deliveries, Earning: NPR {earning}")
...
for partner in partners:
    if partner.total_earning() > top_partner.total_earning():
        top_partner = partner

print(f"Highest earner: {top_partner.name} with NPR {top_partner.total_earning()}")